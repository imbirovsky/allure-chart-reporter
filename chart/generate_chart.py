...
def generate_chart(total, passed, failed, broken, skipped, sum_duration):
    ...
    plt.text(0, -0.10, f'{int(minutes)}min {int(seconds)}sec', horizontalalignment='center', verticalalignment='center', fontsize=6.5, color='darkgray', fontproperties=CUSTOM_FONT)

    # Add the text "logo_name" to the up of the legend
    plt.text(1.82, 0.6, LOGO_NAME, horizontalalignment='center', verticalalignment='center', fontsize=11.5, color='darkgray', fontproperties=CUSTOM_FONT)
