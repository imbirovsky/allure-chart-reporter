...
def generate_chart(total, passed, failed, broken, skipped, sum_duration):
    ...
    wedges, texts, autotexts = ax.pie(sizes, colors=colors, startangle=90, autopct='%1.2f%%', textprops={'color':'grey'})
    ...
    plt.text(1.82, 0.6, LOGO_NAME, horizontalalignment='center', verticalalignment='center', fontsize=11.5, color='grey', fontproperties=CUSTOM_FONT)
